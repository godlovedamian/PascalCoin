...
Const
  ...
  CT_NetServer_Port = {$IFDEF PRODUCTION}5004{$ELSE}{$IFDEF TESTNET}5104{$ELSE}{$ENDIF}{$ENDIF};
  CT_JSONRPCMinerServer_Port = {$IFDEF PRODUCTION}5009{$ELSE}{$IFDEF TESTNET}5109{$ELSE}{$ENDIF}{$ENDIF};
  CT_JSONRPC_Port = {$IFDEF PRODUCTION}5003{$ELSE}{$IFDEF TESTNET}5103{$ELSE}{$ENDIF}{$ENDIF};
